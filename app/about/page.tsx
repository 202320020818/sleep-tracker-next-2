...
const AboutPage = () => {
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f7fbff_0%,#eef7f4_52%,#fffaf1_100%)] text-slate-900">
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-8 lg:py-24">
        <div className="relative overflow-hidden rounded-[2.5rem] border border-sky-100 bg-white/80 p-8 shadow-[0_30px_100px_rgba(148,163,184,0.16)] backdrop-blur sm:p-10 lg:p-14">
          <div className="absolute -left-16 top-8 h-40 w-40 rounded-full bg-sky-100/70 blur-3xl" />
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href="/sign-up"
                  className="inline-flex items-center justify-center rounded-full bg-slate-900 px-7 py-3 text-sm font-semibold text-white transition hover:bg-sky-600"
                >
                  Get Started
                </Link>
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-7 py-3 text-sm font-semibold text-slate-700 transition hover:border-sky-300 hover:text-sky-700"
                >
                  Contact Us
                </Link>
              </div>
            ...
            <div className="grid gap-4">
              {stats.map((item) => (
                <div
                  key={item.value}
                  className="rounded-[1.75rem] border border-white/80 bg-[linear-gradient(135deg,#ffffff_0%,#f8fbff_100%)] p-5 shadow-[0_18px_50px_rgba(148,163,184,0.14)]"
                >
        ...
        <section className="mt-10 grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="rounded-[2.25rem] border border-amber-100 bg-[#fffaf2] p-8 shadow-[0_22px_70px_rgba(245,158,11,0.1)] sm:p-10">
        ...
        <section className="mt-10 rounded-[2.5rem] border border-slate-200 bg-white p-8 shadow-[0_24px_80px_rgba(148,163,184,0.12)] sm:p-10 lg:p-12">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {benefits.map((benefit) => (
              <div
                key={benefit.title}
                className="rounded-[1.75rem] border border-slate-100 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_100%)] p-6 shadow-[0_18px_45px_rgba(148,163,184,0.1)]"
              >
        ...
        <section className="mt-10 rounded-[2.5rem] border border-sky-100 bg-[linear-gradient(135deg,#eff8ff_0%,#f0fdf4_100%)] px-6 py-10 text-center shadow-[0_20px_70px_rgba(125,211,252,0.16)] sm:px-10 lg:px-16">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-sky-700">
