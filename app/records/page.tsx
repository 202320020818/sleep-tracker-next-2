            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex min-w-[190px] items-center justify-center rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-sky-300 hover:text-sky-700"
                >
                  Go to Exercise
                </Link>
              </div>
            ...
            {exercises === null ? (
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                {exercises.map((exercise) => (
                  ...
                  >
                    <div className="relative aspect-[4/4.2] bg-slate-100">
                      <img
                    ...
                    <div className="p-3">
                      ...
                      <div className="mt-2 rounded-[0.95rem] bg-slate-50 px-3 py-2.5 ring-1 ring-slate-200">
                      ...
                      <h4 className="mt-2 text-[15px] font-semibold text-slate-900 line-clamp-1">
                        {exercise.title}
                      </h4>
